...
import type { UniswapV3Types } from './sources/Uniswap-V3/types';
...
const uniswapV3Handler = new GraphqlHandler({
              ...
              cache,
              pubsub,
              store: sourcesStore.child("Uniswap-V3"),
              logger: logger.child("Uniswap-V3"),
              importFn,
            });
sources[0] = {
          name: 'Uniswap-V3',
...
const documentHashMap = {
        "388982496d7223a6c4a59163955b75241ab5211502d98d4984978e653795698c": GetBundlesDocument
      }
additionalEnvelopPlugins.push(usePersistedOperations({
  ...
  return {
    ...
    get documents() {
      return [
      {
        document: GetBundlesDocument,
        get rawSDL() {
          return printWithCache(GetBundlesDocument);
        },
        location: 'GetBundlesDocument.graphql',
        sha256Hash: '388982496d7223a6c4a59163955b75241ab5211502d98d4984978e653795698c'
      }
    ];
    },
    fetchFn,
...
export type GetBundlesQuery = { bundles: Array<Pick<Bundle, 'id' | 'ethPriceUSD'>> };


export const GetBundlesDocument = gql`
    query GetBundles {
  bundles(first: 5) {
    id
    ethPriceUSD
    ...
    ` as unknown as DocumentNode<GetBundlesQuery, GetBundlesQueryVariables>;


export type Requester<C = {}, E = unknown> = <R, V>(doc: DocumentNode, vars?: V, options?: C) => Promise<R> | AsyncIterable<R>
export function getSdk<C, E>(requester: Requester<C, E>) {
  return {
    GetBundles(variables?: GetBundlesQueryVariables, options?: C): Promise<GetBundlesQuery> {
      return requester<GetBundlesQuery, GetBundlesQueryVariables>(GetBundlesDocument, variables, options) as Promise<GetBundlesQuery>;
    }
  };
}
